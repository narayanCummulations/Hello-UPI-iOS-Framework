...
class ContactsManager: ObservableObject {
    ...
    func uploadContacts(completion: @escaping (Bool, String) -> Void) {
        ...
        var userID = "n/a"
        userID = MySDK.shared.configuration?.email ?? UUID().uuidString
...
//            "t_s": Int(Date().timeIntervalSince1970),
        ...
        do {
            ...
            var subsString = "5c4ce509a317d0026743b167046805fa53ff3d5009530ac9c22d69fd0d326e61"
            
            if let enteredSubscriptionKey = UserDefaults.standard.string(forKey: "enteredSubscriptionKey") {
                subsString = enteredSubscriptionKey
            }
            print("here is subString UserDefaults: - \(subsString)")
